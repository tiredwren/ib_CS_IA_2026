...
class _SignupState extends State<SignupScreen> {
  ...
  // age group derived from program selection, written to Firestore
  // used to filter calendar events by eligible age group
  String _ageG = 'Youth';
  bool _loading = false;
  bool _hidePass = true;
  bool _isAdmin = false;
  ...
  // map program to age group so calendar can filter by it
  String _progAgeG(String program) {
    if (program == 'Pee Wee Kickers (ages 3 - 5)') return 'Kids';
    if (program == 'Teen/Adult (ages 13+)') return 'Adult';
    return 'All';
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<bool>(
                    ...
                    items: const [
                      DropdownMenuItem(
                          value: false, child: Text('Student')),
                      DropdownMenuItem(
                          value: true, child: Text('Admin')),
                    ],
                    onChanged: (v) =>
                        setState(() => _isAdmin = v!),
                  ),
                  ...
                  if (!_isAdmin) ...[
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      onChanged: (v) => setState(() {
                        _program = v!;
                        // derive age group from program selection
                        _ageG =
                            _progAgeG(_program);
                      }),
                    ),
                  ...
                  TextFormField(
                    ...
                    validator: (v) {
                      // ensure valid email so TMA can send emails
                      if (v == null || v.isEmpty)
